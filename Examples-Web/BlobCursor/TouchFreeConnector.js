...
window.onload = function () {
    ...
    var plugins = [
        new SnappingPlugin.SnappingPlugin()
    ];
    ...
    TouchFree.Plugins.InputActionManager.plugins[0].SetSnapDistance(50);
    TouchFree.Plugins.InputActionManager.plugins[0].SetSnapSoftness(0.4);
}
