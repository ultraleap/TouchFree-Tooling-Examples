...
export class ServiceConnection {
    ...
    SendMessage(_message: string, _requestID: string, _callback: (detail: WebSocketResponse) => void): void {
        if (_requestID === '') {
            if (_callback !== null) {
    ...
    RequestConfigState(_callback: (detail: ConfigState) => void): void {
        ...
        let wrapper: CommunicationWrapper<any> = new CommunicationWrapper<ConfigChangeRequest>(
