...
public class MagneticSnapPlugin : InputActionPlugin
{
    ...
    protected override InputAction? ModifyInputAction(InputAction _inputAction)
    {
        ...
        {
            _inputAction = new InputAction(_inputAction.Timestamp, _inputAction.InteractionType, _inputAction.HandType, _inputAction.Chirality, _inputAction.InputType, nearestBtnPos, _inputAction.DistanceFromScreen, _inputAction.ProgressToClick);
        }
